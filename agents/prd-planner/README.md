...
2. Ask Claude to read this agent's `README.md`, `AGENT.md`, and `config.yaml`.
3. Provide either `prd_path` or `prd_markdown`.
4. Let Claude execute the steps defined in `AGENT.md`.
5. Review the generated `prd-output/` structure and the final summary.
